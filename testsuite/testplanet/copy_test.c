...
void handle_project(UplinkProject *project)
{
...

    {
        ...
        UplinkObjectResult copy_result =
            uplink_copy_object(project, "alpha", "data.txt", "alpha", "a/prefix/data.txt", NULL);
        require_noerror(copy_result.error);
        require(copy_result.object != NULL);
        ...
        uplink_free_object_result(copy_result);
